...
import GenerateBlogPostForm from "../../pages/Admin/components/GenerateBlogPostForm";
...
function BlogPostEditor({ isEdit }) {
  ...
  const handlePublish = async (isDraft) => {
    ...
    setError("");
    try {
      //check if a new image was uploaded (file upload)
